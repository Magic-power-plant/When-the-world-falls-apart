...
ServerEvents.recipes(event => {
    ...
    event.recipes.mbd2.dwarf_alchemy_cauldron()
        .duration(1000)
        .inputItems([Item.of('avaritia:singularity',8, '{Id:"avaritia:glowstone"}').weakNBT(),"kubejs:dimensional_reath"])
        .outputItems('aether:aether_portal_frame')
        .blocksInStructure(1, 1, "mbd2:liquid_ember_complete_combustion_unit")
        .perTick((builder:Internal.MBDRecipeSchema$MBDRecipeJS) => builder.inputFluids("embers_extended:liquid_ember 50"))
        .id("kubejs:aether_portal_frame_from_dwarf_alchemy_cauldron")
    
    event.recipes.mbd2.dwarf_alchemy_cauldron()
        .duration(100)
        .inputItems(["32x divinerpg:aquatic_ingot","24x divinerpg:aqua_ball","enchanted:otherwhere_chalk","16x enchanted:quicklime"] as unknown as InputItem_)
        .outputItems("wtwfacore:light_blue_chalk")
        .blocksInStructure(1, 1, "mbd2:liquid_ember_complete_combustion_unit")
        .perTick((builder:Internal.MBDRecipeSchema$MBDRecipeJS) => builder.inputFluids("embers_extended:liquid_ember 100"))
        .id("kubejs:light_blue_chalk_from_dwarf_alchemy_cauldron")
})
